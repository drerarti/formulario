...
// ==============================
// OBTENER RESERVA PARA BOLETA
// ==============================

if (body.action === "obtener_reserva") {

  const reservaId = body.id;
...
const { reservaId, cliente, dni, descripcion, monto } = body;
...
console.log("STATUS NUBEFACT:", response.status);
console.log("HEADERS NUBEFACT:", response.headers);
console.log("JSON ENVIADO A NUBEFACT:", JSON.stringify({
cliente,
dni,
descripcion,
montoNumero
...
console.log("RESPUESTA NUBEFACT COMPLETA:", JSON.stringify(nubefact,null,2));
await fetch(
  `https://api.airtable.com/v0/${BASE_ID}/RESERVAS/${reservaId}`,
  {
    method:"PATCH",
...
console.log("RESPUESTA NUBEFACT:", nubefact);
return {
statusCode:200,
body:JSON.stringify({
serie:nubefact.serie,
